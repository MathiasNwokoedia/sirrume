        ...
        <div className="container mx-auto px-6 lg:px-12">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl lg:text-2xl text-charcoal/70">
              Ready to transform your team or event? Let&apos;s start a
              conversation.
            </p>
          </div>
        </div>
            ...
            <div>
              ...
              <div className="space-y-6 mb-12">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-lg font-serif mb-1 text-charcoal">
                      Email
                    </h4>
                    <a
              ...
              <div className="bg-cream p-8 rounded-2xl shadow-luxury">
                ...
                <div className="space-y-3">
                  ...
                  <Link
                    ...
                    className="block w-full text-left text-charcoal/70 hover:text-gold transition-colors"
                  >
                    &rarr; Register for Talent Rescue
                  </Link>
                  <Link
                    href="/hosting"
                    className="block w-full text-left text-charcoal/70 hover:text-gold transition-colors"
                  >
                    &rarr; Event Hosting Services
                  </Link>
                  <Link
                    href="/coaching"
                    className="block w-full text-left text-charcoal/70 hover:text-gold transition-colors"
                  >
                    &rarr; Coaching Programs
                  </Link>
                </div>
              </div>
            </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="hosting" className="bg-charcoal">
                        Event Hosting
                      </option>
                      <option value="coaching" className="bg-charcoal">
                        Coaching Services
                      </option>
                      <option value="talent-rescue" className="bg-charcoal">
                        Talent Rescue Program
                      </option>
      ...
      <section className="py-20 lg:py-32 bg-gold">
        <div className="container mx-auto px-6 lg:px-12 text-center">
          ...
          <p className="text-xl text-charcoal/80 mb-10 max-w-2xl mx-auto">
            Whether you need a host for your event or coaching for your team,
            we&apos;re here to help.
          </p>
